    ...
    <main className="flex flex-col">
      <div className="flex-1 justify-center px-6 py-12 lg:px-8">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div
            className={cn(
              "mx-4 mt-2 flex flex-row justify-stretch rounded-md border border-red-300 bg-red-200 px-1 py-2 align-middle",
        ...
        <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div className={cn({ hidden: viewType !== ViewType.LoginView })}>
            ...
            <button
              className="my-3 flex w-full justify-center rounded-lg border border-gray-300 bg-white px-6 
              py-2 align-middle text-sm font-medium text-gray-800 shadow-sm hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
            ...
            <button
              className="my-3 flex w-full justify-center rounded-lg border border-gray-300 bg-white px-6 py-2 
              align-middle text-sm font-medium text-gray-800 shadow-sm hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
            ...
            >
              ...
              <span className="self-center">Continue with Facebook</span>
            </button>
          </div>
        </div>
      </div>
